    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-slate-50 py-16 flex-grow">
        <div className="container mx-auto px-4 md:px-6">
          ...
          {/* PDF リンク */}
          <div className="mt-16 bg-white rounded-xl border border-gray-200 p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm">
            <div>
              <h3 className={`text-xl font-bold text-navy-900 mb-2 ${notoSerifJP.className}`}>
                SCJの自主事業等詳細（令和6年度）
              </h3>
              <p className="text-gray-500 text-sm">
                全事業の詳細はPDFドキュメントでもご覧いただけます。
              </p>
            </div>
            <a
              ...
              className="shrink-0 inline-flex items-center gap-2 bg-navy-900 text-white px-6 py-3 rounded-lg font-bold hover:bg-navy-800 transition-colors shadow-sm"
            >
